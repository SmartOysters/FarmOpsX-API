...
namespace SmartOysters\FarmOpsX\Resources\Base;

use SmartOysters\FarmOpsX\Helpers\ArrayHelpers;
use SmartOysters\FarmOpsX\Helpers\StringHelpers;
use SmartOysters\FarmOpsX\Http\Response;
use ReflectionClass;
...
abstract class Resource
{
    ...
    public function __call($method, $args = [])
    {
        if (! $this->isEnabled($method)) {
            throw new FarmOpsXException("The method {$method}() is not available for the resource {$this->getName()}");
        }
    }
}
